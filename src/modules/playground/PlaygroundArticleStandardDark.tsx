...
export const PlaygroundArticleStandardDark = () => {
    const navigate = useNavigate();
    const [isChatOpen, setIsChatOpen] = useState(false);

    return (
        <PageWrapper>
            <div style={{ maxWidth: '480px', margin: '0 auto', width: '100%', backgroundColor: '#111827', minHeight: '100vh', position: 'relative' }}>
                ...
                <div style={{ textAlign: 'center', paddingTop: '24px', paddingBottom: '16px' }}>
                    ...
                    <Heading level={1} style={{ fontSize: '2rem', lineHeight: '1.2', fontWeight: 800, color: '#F9FAFB', margin: '0 16px' }}>
                    ...
                    {/* Divider */}
                    <div style={{ height: '1px', backgroundColor: '#374151', width: '100%', marginTop: '24px' }}></div>
                </div>

                {/* 2. Hero image with ZoomableImage */}
                ...
                <div style={{ padding: '0 16px 120px 16px' }}>
                    <Text variant="body" style={{ fontSize: '1.125rem', lineHeight: '1.75', color: '#D1D5DB' }}>
